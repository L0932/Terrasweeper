...
public class DESEncryption : IEncryption {
	...
	public string Encrypt(string plainText, string password){
		...
		// generae a random will be used a salt value for generating a key
		des.GenerateIV();

		// use derived btyes to genered a key from the password and IV
	...
	public bool TryDecrypt(string cipherText, string password, out string plainText)
	{
		...
		//it is unecessary to decrypt if the cipher text
